 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class PS{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(n=>{if(xS(n)){const s=n.getImmediate();return`${s.library}/${s.version}`}else return null}).filter(n=>n).join(" ")}}function xS(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const bl="@firebase/app",cd="0.9.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pi{constructor(e,n){this.shortDelay=e,this.longDelay=n,vn(n>e,"Short delay should be less than long delay!"),this.isMobile=tS()||sS()}get(){return TC()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hi(t,e,n=!1){if(n)return e;try{return await e}catch(s){throw s instanceof Cn&&PC(s)&&t.auth.currentUser===t&&await t.auth.signOut(),s}}function PC({code:t}){return t==="auth/user-disabled"||t==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function $C(t,e){const n=await xm(t,{},async()=>{const s=Di({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:i}=t.config,o=Lm(t,r,"/v1/token",`key=${i}`),a=await t._getAdditionalHeaders();return a["Content-Type"]="application/x-www-form-urlencoded",Dm.fetch()(o,{method:"POST",headers:a,body:s})});return{accessToken:n.access_token,expiresIn:n.expires_in,refreshToken:n.refresh_token}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Do(t,e,n){return`firebase:${t}:${e}:${n}`}class Qs{constructor(e,n,s){this.persistence=e,this.auth=n,this.userKey=s;const{config:r,name:i}=this.auth;this.fullUserKey=Do(this.userKey,r.apiKey,i),this.fullPersistenceKey=Do("persistence",r.apiKey,i),this.boundEventHandler=n._onStorageEvent.bind(n),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);return e?_s._fromJSON(this.auth,e):null}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const n=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,n)return this.setCurrentUser(n)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,n,s="authUser"){if(!n.length)return new Qs(pn(pd),e,s);const r=(await Promise.all(n.map(async l=>{if(await l._isAvailable())return l}))).filter(l=>l);let i=r[0]||pn(pd);const o=Do(s,e.config.apiKey,e.name);let a=null;for(const l of n)try{const u=await l._get(o);if(u){const h=_s._fromJSON(e,u);l!==i&&(a=h),i=l;break}}catch{}const c=r.filter(l=>l._shouldAllowMigration);return!i._shouldAllowMigration||!c.length?new Qs(i,e,s):(i=c[0],a&&await i._set(o,a.toJSON()),await Promise.all(n.map(async l=>{if(l!==i)try{await l._remove(o)}catch{}})),new Qs(i,e,s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function YC(t,e){const n=Du(t,"auth");if(n.isInitialized()){const r=n.getImmediate(),i=n.getOptions();if(Yo(i,e??{}))return r;rn(r,"already-initialized")}return n.initialize({options:e})}function JC(t,e){const n=(e==null?void 0:e.persistence)||[],s=(Array.isArray(n)?n:[n]).map(pn);e!=null&&e.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(s,e==null?void 0:e.popupRedirectResolver)}function XC(t,e,n){const s=Li(t);se(s._canInitEmulator,s,"emulator-config-failed"),se(/^https?:\/\//.test(e),s,"invalid-emulator-scheme");const r=!!(n!=null&&n.disableWarnings),i=Qm(e),{host:o,port:a}=ZC(e),c=a===null?"":`:${a}`;s.config.emulator={url:`${i}//${o}${c}/`},s.settings.appVerificationDisabledForTesting=!0,s.emulatorConfig=Object.freeze({host:o,port:a,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:r})}),r||eb()}function Qm(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function ZC(t){const e=Qm(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const s=n[2].split("@").pop()||"",r=/^(\[[^\]]+\])(:|$)/.exec(s);if(r){const i=r[1];return{host:i,port:vd(s.substr(i.length+1))}}else{const[i,o]=s.split(":");return{host:i,port:vd(o)}}}function vd(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function eb(){function t(){const e=document.createElement("p"),n=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",n.position="fixed",n.width="100%",n.backgroundColor="#ffffff",n.border=".1em solid #000000",n.color="#b50000",n.bottom="0px",n.left="0px",n.margin="0px",n.zIndex="10000",n.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",t):t())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ys(t,e){return AC(t,"POST","/v1/accounts:signInWithIdp",Pm(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const kb="pendingRedirect",Po=new Map;class Nb extends cy{constructor(e,n,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],n,void 0,s),this.eventId=null}async execute(){let e=Po.get(this.auth._key());if(!e){try{const s=await Ob(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(n){e=()=>Promise.reject(n)}Po.set(this.auth._key(),e)}return this.bypassAuthState||Po.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const n=await this.auth._redirectUserForId(e.eventId);if(n)return this.user=n,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Ob(t,e){const n=xb(e),s=Pb(t);if(!await s._isAvailable())return!1;const r=await s._get(n)==="true";return await s._remove(n),r}function Db(t,e){Po.set(t._key(),e)}function Pb(t){return pn(t._redirectPersistence)}function xb(t){return Do(kb,t.config.apiKey,t.name)}async function Lb(t,e,n=!1){const s=Li(t),r=ay(s,e),o=await new Nb(s,r,n).execute();return o&&!n&&(delete o.user._redirectEventId,await s._persistUserIfCurrent(o.user),await s._setRedirectUser(null,e)),o}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gb=new Pi(5e3,15e3),Wb="__/auth/iframe",Qb="emulator/auth/iframe",Yb={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Jb=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Xb(t){const e=t.config;se(e.authDomain,t,"auth-domain-config-required");const n=e.emulator?Lu(e,Qb):`https://${t.config.authDomain}/${Wb}`,s={apiKey:e.apiKey,appName:t.name,v:Ir},r=Jb.get(t.config.apiHost);r&&(s.eid=r);const i=t._getFrameworks();return i.length&&(s.fw=i.join(",")),`${n}?${Di(s).slice(1)}`}async function Zb(t){const e=await Kb(t),n=Zt().gapi;return se(n,t,"internal-error"),e.open({where:document.body,url:Xb(t),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Yb,dontclear:!0},s=>new Promise(async(r,i)=>{await s.restyle({setHideOnLeave:!1});const o=Xt(t,"network-request-failed"),a=Zt().setTimeout(()=>{i(o)},Gb.get());function c(){Zt().clearTimeout(a),r(s)}s.ping(c).then(c,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function X(t="Unexpected state"){const e=`FIRESTORE (${Cr}) INTERNAL ASSERTION FAILED: `+t;throw wn(e),new Error(e)}function Pe(t,e){t||X()}function oe(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function P2(t){const e=typeof self<"u"&&(self.crypto||self.msCrypto),n=new Uint8Array(t);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(n);else for(let s=0;s<t;s++)n[s]=Math.floor(256*Math.random());return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class pt{constructor(e){this.binaryString=e}static fromBase64String(e){const n=function(s){try{return atob(s)}catch(r){throw typeof DOMException<"u"&&r instanceof DOMException?new gv("Invalid base64 string: "+r):r}}(e);return new pt(n)}static fromUint8Array(e){const n=function(s){let r="";for(let i=0;i<s.length;++i)r+=String.fromCharCode(s[i]);return r}(e);return new pt(n)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return e=this.binaryString,btoa(e);var e}toUint8Array(){return function(e){const n=new Uint8Array(e.length);for(let s=0;s<e.length;s++)n[s]=e.charCodeAt(s);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return me(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}pt.EMPTY_BYTE_STRING=new pt("");const V2=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function Jn(t){if(Pe(!!t),typeof t=="string"){let e=0;const n=V2.exec(t);if(Pe(!!n),n[1]){let r=n[1];r=(r+"000000000").substr(0,9),e=Number(r)}const s=new Date(t);return{seconds:Math.floor(s.getTime()/1e3),nanos:e}}return{seconds:Ve(t.seconds),nanos:Ve(t.nanos)}}function Ve(t){return typeof t=="number"?t:typeof t=="string"?Number(t):0}function As(t){return typeof t=="string"?pt.fromBase64String(t):pt.fromUint8Array(t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Kn(DN,PN,"app");const xN="AIzaSyD1Bi6E9X3YE877MiJhntcz__m8GYD5u90",LN={apiKey:xN,authDomain:"hh-easy-reach.firebaseapp.com",projectId:"hh-easy-reach",storageBucket:"hh-easy-reach.appspot.com",messagingSenderId:"180032379271",appId:"1:180032379271:web:0d70108e46a2d661fd1b22"},MN=Cm(LN),vr=hN(MN),dO="https://us-central1-hh-easy-reach.cloudfunctions.net/",pO=async(t,e=null)=>{let n;e?n=tu(va(vr,t),IN(e)):n=tu(va(vr,t));const s=await b0(n);return Array.from(s.docs).map(i=>({...i.data(),id:i.id}))},gO=async(t,e)=>{await kN(Ph(vr,t),e,{merge:!0})},mO=async(t,e)=>{const n=va(vr,t);return await ON(n,e)},yO=async(t,e)=>{const n=Ph(vr,t,e);return await NN(n)},FN=async t=>{const e=tu(va(vr,"users"),EN("email","==",t),TN(1)),n=await b0(e);if(Array.from(n.docs).map(r=>({...r.data(),id:r.id})).length)return!0;throw new Error("User not authorized to log in")},$N={__name:"HomeView",setup(t){const e=Vu(),n=()=>{const r=new hn;Rb(sa(),r).then(i=>{FN(i.user.email).then(()=>{e.setUser(i.user),yc.push({name:"Arrivals"})}).catch(o=>{console.log(o.message),s()})}).catch(i=>{console.log("error",i)})},s=()=>{Xm(sa()).then(()=>{e.setUser(null)}).catch(r=>console.log("error",r))};return(r,i)=>(De(),Fe("main",null,[Ee("div",{class:"flex justify-center mt-20"},[Ee("button",{onClick:n,class:"bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 rounded shadow"}," Sign in with Google ")])]))}},yc=UT({history:pT("/hh-easy-reach"),routes:[{path:"/",name:"Home",component:$N},{path:"/arrivals",name:"Arrivals",component:()=>sd(()=>import("./ArrivalsView-423b987a.js"),["assets/ArrivalsView-423b987a.js","assets/SelectSkeleton-54f58db0.js","assets/ArrivalsView-9bb43f66.css"]),meta:{requiresAuth:!0}},{path:"/settings",name:"Settings",component:()=>sd(()=>import("./SettingsView-a22c6bda.js"),["assets/SettingsView-a22c6bda.js","assets/SelectSkeleton-54f58db0.js","assets/SettingsView-71ad89fb.css"]),meta:{requiresAuth:!0}}]}),UN=()=>new Promise((t,e)=>{const n=Vu();ab(sa(),s=>{s?(n.setUser(s),t(s)):(n.setUser(null),e("User not logged in"))})});yc.beforeEach(async(t,e,n)=>{if(t.matched.some(s=>s.meta.requiresAuth))try{await UN(),n()}catch(s){console.log(s),n("/")}else n()});const BN={class:"border-b border-gray-200 bg-orange-600"},VN={class:"max-w-screen-xl flex justify-between mx-auto px-6 xl:px-0"},jN=Ee("div",{class:"logo flex items-center"},[Ee("div",{class:"truncate text-white font-medium border-l-4 border-orange-400 transition hover:text-gray-100 my-4 px-3 py-1"},[Ee("span",{class:"sm:hidden"}," HH/ER "),Ee("span",{class:"hidden sm:block"},"HH - Easy Reach")])],-1),qN={key:0,class:"flex items-center gap-4"},HN=Ee("img",{src:jT,alt:"Logout icon"},null,-1),zN=[HN],KN={__name:"HeaderMenu",setup(t){const e=VT(),n=o=>e.path===o?"bg-orange-400":"",s=()=>e.path==="/arrivals"||e.path==="/settings",r=Vu(),i=()=>{Xm(sa()).then(()=>{r.setUser(null)}).catch(o=>console.log("error",o)).finally(()=>yc.push("/"))};return(o,a)=>{const c=C_("router-link");return De(),Fe("header",BN,[Ee("div",VN,[jN,Yt(r).user&&s?(De(),Fe("div",qN,[ae(c,{to:"/arrivals",class:ei(`sm:w-28 py-1.5 px-2 text-center text-sm text-white sm:border sm:border-gray-100 ${n("/arrivals")}`)},{default:nl(()=>[ll("ARRIVALS")]),_:1},8,["class"]),ae(c,{to:"/settings",class:ei(`sm:w-28 py-1.5 px-2 text-center text-sm text-white sm:border sm:border-gray-100 ${n("/settings")}`)},{default:nl(()=>[ll("SETTINGS")]),_:1},8,["class"])])):Sc("",!0),Yt(r).user?(De(),Fe("div",{key:1,onClick:i,class:"hidden sm:flex text-white items-center px-4 cursor-pointer hover:text-gray-100"}," Sign out ")):Sc("",!0),Yt(r).user?(De(),Fe("div",{key:2,onClick:i,class:"w-12 flex sm:hidden text-white items-center px-4 cursor-pointer hover:text-gray-100"},zN)):Sc("",!0)])])}}},GN={},WN={class:"text-center border-t border-gray-200 bg-orange-600 py-2"},QN=Ee("span",{class:"text-white"},"2024",-1),YN=[QN];function JN(t,e){return De(),Fe("footer",WN,YN)}const XN=nt(GN,[["render",JN]]);const ZN={class:"flex flex-col h-screen justify-between text-slate-800"},eO={class:"mb-auto bg-white"},tO={class:"max-w-screen-xl mx-auto px-6 xl:px-0"},nO={__name:"App",setup(t){return(e,n)=>(De(),Fe("div",ZN,[ae(KN),Ee("main",eO,[Ee("div",tO,[ae(Yt(mm))])]),ae(XN)]))}},sO=nt(nO,[["__scopeId","data-v-8ebac9e5"]]),eo=Hg(sO);eo.component("EditIcon",uw).component("EmailIcon",mw).component("EmailLightIcon",Iw).component("WhatsAppIcon",Rw).component("CancelIcon",xw).component("ThumbsDownIcon",Bw).component("ThumbsUpIcon",Kw).component("SentIcon",Xw).component("LeftTriangleIcon",rE).component("RightTriangleIcon",uE).component("RefreshIcon",mE).component("GuestsIcon",IE).component("ProgressionIcon",RE).component("LoadIcon",xE).component("ArrowDownIcon",BE);eo.use(em,{autoClose:3e3,transition:"slide",hideProgressBar:!0});eo.use(NI());eo.use(yc);eo.mount("#app");export{hO as A,Ra as B,lO as C,yO as D,ze as E,wt as F,qr as G,Mg as H,rO as S,uO as T,nt as _,mO as a,Se as b,Fe as c,MI as d,C_ as e,dO as f,Ee as g,ae as h,Yt as i,ll as j,cO as k,Oe as l,Dg as m,ei as n,De as o,iO as p,pO as q,aO as r,gO as s,B0 as t,Vu as u,oO as v,nl as w,fO as x,fn as y,Sc as z};
